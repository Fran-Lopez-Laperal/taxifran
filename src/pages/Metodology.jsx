        ...
        <div className='mt-64'>
            <figure className='flex flex-col justify-center items-center mb-64'>
                ...
                <section className='lg:flex'>
                    <div className='relative h-auto w-320 bg-gray-200 bg-opacity-70 shadow-lg p-7 shadow-black lg:w-800 lg:h-72 lg:flex lg:flex-col lg:justify-center'>
                        <p className='text-3xl lg:text-4xl'>Nuestra metodología de trabajo</p>
                    ...
                    <section className='lg:flex'>
                        <Button buttonname="¿HABLAMOS?" margin="mt-10" lgMargin='lg:mt-72' side="ml-72" width='w-36' height='h-10' lgHeight='w-48' lgWidth='h-16' lgText='lg:text-2xl'  />
                    </section>
                </section>
